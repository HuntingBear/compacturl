...
public class CompactUrlService {
    ...
    @Transactional
    public synchronized Url atomicAddUrl(String originalUrl, String idempotenceKey) {
        String generatedId = idGenerator.generate();
        return urlRepository.addUrlIfKeyNotFound(generatedId, originalUrl, idempotenceKey);
    }
